# Hi there, I'm a Dual Enrollment IT Student! 👋
...
*   **CIT-125 (Web Design & Development):** Modern CSS Layouts (Flexbox/Grid), structural HTML5, and responsive design.

### 🛠️ Core Skills
*   **Languages:** Java, HTML5, CSS3
*   **Tools & IDEs:** NetBeans, Git, GitHub
*   **Concepts:** Networking, Cloud Basics, Tech Security, Object-Oriented Programming (OOP)

### 📁 Featured Projects
*   [Mixup - Creative Coding Platform](https://github.io) - A responsive multi-page student showcase platform implementing modern Flexbox layout architecture.

---
📫 *Building a strong foundation in computer information systems, one repository at a time.*
